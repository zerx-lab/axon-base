...
const translations: Translations = {
  ...
  "common.select": { zh: "请选择", en: "Please select" },
  ...
  // Chat - New additions for independent chat page
  "chat.newSession": { zh: "新建会话", en: "New Session" },
  "chat.selectKnowledgeBase": { zh: "选择知识库", en: "Select Knowledge Base" },
  "chat.noKnowledgeBases": { zh: "没有可用的知识库", en: "No knowledge bases available" },
  "chat.selectKbFirst": { zh: "请先选择知识库", en: "Please select a knowledge base first" },
  "chat.startChat": { zh: "开始对话", en: "Start Chat" },
  "chat.welcome": { zh: "欢迎使用 AI 对话", en: "Welcome to AI Chat" },
  "chat.selectOrCreate": { zh: "选择或创建一个会话开始", en: "Select or create a session to start" },
  "chat.knowledgeBase": { zh: "知识库", en: "Knowledge Base" },
  "chat.noMessages": { zh: "暂无消息", en: "No messages yet" },
  "chat.startConversation": { zh: "输入消息开始对话", en: "Type a message to start the conversation" },
  "chat.enterToSend": { zh: "按 Enter 发送，Shift+Enter 换行", en: "Press Enter to send, Shift+Enter for new line" },
  "chat.errorSending": { zh: "发送失败", en: "Failed to send message" },
  ...
  "settings.importExport": { zh: "配置导入导出", en: "Import/Export Configuration" },
  "settings.importExportDesc": { zh: "导出当前配置或从文件导入配置", en: "Export current settings or import from file" },
  ...
  "settings.includeApiKeys": { zh: "包含 API 密钥", en: "Include API Keys" },
  "settings.includeApiKeysDesc": { zh: "导出文件将包含敏感的 API 密钥信息", en: "Export file will include sensitive API key information" },
  "settings.exportSuccess": { zh: "配置导出成功", en: "Configuration exported successfully" },
  "settings.exportFailed": { zh: "配置导出失败", en: "Failed to export configuration" },
  "settings.importSuccess": { zh: "配置导入成功", en: "Configuration imported successfully" },
  "settings.importFailed": { zh: "配置导入失败", en: "Failed to import configuration" },
  "settings.invalidConfigFile": { zh: "无效的配置文件格式", en: "Invalid configuration file format" },
  "settings.confirmImport": { zh: "确认导入", en: "Confirm Import" },
  "settings.confirmImportDesc": { zh: "导入将覆盖当前配置，是否继续？", en: "Import will overwrite current settings. Continue?" },
  "settings.selectConfigFile": { zh: "选择配置文件", en: "Select Config File" },
  "settings.dragDropConfig": { zh: "点击选择或拖拽配置文件", en: "Click to select or drag config file" },
  "settings.supportedFormat": { zh: "支持 .json 格式", en: "Supports .json format" },
  "settings.importPreview": { zh: "导入预览", en: "Import Preview" },
  "settings.configContains": { zh: "配置包含", en: "Config contains" },
  "settings.embeddingConfigLabel": { zh: "向量模型配置", en: "Embedding Config" },
  "settings.chatConfigLabel": { zh: "聊天模型配置", en: "Chat Config" },
  "settings.rerankerConfigLabel": { zh: "重排模型配置", en: "Reranker Config" },
  "settings.qualityConfigLabel": { zh: "质量控制配置", en: "Quality Config" },
  "settings.promptConfigLabel": { zh: "提示词配置", en: "Prompt Config" },
  "settings.apiKeysWarning": { zh: "注意：导出的文件包含 API 密钥，请妥善保管", en: "Warning: Exported file contains API keys, please keep it safe" },
  "settings.noApiKeysIncluded": { zh: "配置不包含 API 密钥", en: "Config does not include API keys" },
  ...
  "nav.kbPermissions": { zh: "知识库权限", en: "KB Permissions" },

  // Knowledge Base Permissions
  "kbPermissions.title": { zh: "知识库权限管理", en: "Knowledge Base Permissions" },
  "kbPermissions.description": { zh: "管理用户对知识库的访问权限", en: "Manage user access to knowledge bases" },
  "kbPermissions.addPermission": { zh: "添加权限", en: "Add Permission" },
  "kbPermissions.editPermission": { zh: "编辑权限", en: "Edit Permission" },
  "kbPermissions.selectUserAndKb": { zh: "请选择用户和知识库", en: "Please select user and knowledge base" },
  "kbPermissions.confirmDelete": { zh: "确定要删除这个权限吗？", en: "Are you sure you want to delete this permission?" },
  "kbPermissions.filterByUser": { zh: "按用户筛选", en: "Filter by User" },
  "kbPermissions.filterByKb": { zh: "按知识库筛选", en: "Filter by Knowledge Base" },
  "kbPermissions.grantSelected": { zh: "批量授权", en: "Grant Selected" },
  "kbPermissions.deleteSelected": { zh: "批量删除", en: "Delete Selected" },
  "kbPermissions.user": { zh: "用户", en: "User" },
  "kbPermissions.knowledgeBase": { zh: "知识库", en: "Knowledge Base" },
  "kbPermissions.permissions": { zh: "权限", en: "Permissions" },
  "kbPermissions.noPermissions": { zh: "暂无权限记录", en: "No permissions found" },
  "kbPermissions.canRead": { zh: "可查看", en: "Can Read" },
  "kbPermissions.canAsk": { zh: "可提问", en: "Can Ask" },
  "kbPermissions.canReadDesc": { zh: "允许查看知识库内容", en: "Allow viewing knowledge base content" },
  "kbPermissions.canAskDesc": { zh: "允许向知识库提问", en: "Allow asking questions to knowledge base" },
  "kbPermissions.role": { zh: "角色", en: "Role" },
  "kbPermissions.filterByRole": { zh: "按角色筛选", en: "Filter by Role" },
  "kbPermissions.selectRole": { zh: "选择角色", en: "Select Role" },
  "kbPermissions.selectRoleAndKb": { zh: "请选择角色和知识库", en: "Please select role and knowledge base" },
  "kbPermissions.selectUser": { zh: "选择用户", en: "Select User" },
  "kbPermissions.selectKnowledgeBase": { zh: "选择知识库", en: "Select Knowledge Base" },
  "kbPermissions.batchOperation": { zh: "批量操作", en: "Batch Operation" },
  "kbPermissions.batchOperationDesc": { zh: "确定要对选中的权限执行此操作吗？", en: "Are you sure you want to perform this operation on selected permissions?" },
  ...
  "chat.referenceSources": { zh: "参考来源", en: "Reference Sources" },
  ...
  "chat.welcomeTitle": { zh: "你好！", en: "Hello there!" },
  "chat.welcomeSubtitle": { zh: "有什么我可以帮助你的？", en: "How can I help you today?" },
  "chat.edit": { zh: "编辑", en: "Edit" },
  "chat.update": { zh: "更新", en: "Update" },
  "chat.previous": { zh: "上一条", en: "Previous" },
  "chat.next": { zh: "下一条", en: "Next" },
